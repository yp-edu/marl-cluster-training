"""
Run a single PettingZoo task with MAPPO.

Run with:

```bash
uv run python -m scripts.experiments.multiwalker_mappo
```
"""
...
@hydra.main(version_base=None, config_path="../../configs", config_name="exp:multiwalker_mappo")
def main(cfg: DictConfig):
    experiment = validate_experiment(cfg, ["multiwalker"], ["mappo"], ["mlp"])
    if cfg.clean_folder:
